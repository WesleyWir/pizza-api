...
describe('SizeController', () => {
  ...
  describe('getSize', () => {
    it('should return a size', async () => {
      const mockSize = { id: 1, name: 'Small', price: 100, preparationTime: 20 };
  ...
  describe('getSizes', () => {
    it('should return a list of sizes', async () => {
      const mockSizes = [
        { id: 1, name: 'Small', price: 100, preparationTime: 20, createdAt: null, updatedAt: null },
        { id: 2, name: 'Large', price: 200, preparationTime: 20, createdAt: null, updatedAt: null },
      ];
  ...
  describe('updateSize', () => {
    it('should update a size and return success', async () => {
      ...
      const updateSizeDto = { id: 1, name: 'Medium', price: 150, preparation_time: 20 };
  ...
  describe('createSize', () => {
    it('should create a size and return it', async () => {
      ...
      const createSizeDto = { name: 'Small', price: 100, preparation_time: 20 };
